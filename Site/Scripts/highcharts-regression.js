...
(function (H) {
        ...
        for (i = 0 ; i < series.length ; i++) {
            ...
            if (s.regression && !s.rendered) {
                ...
                if (regressionType == "linear") {
                    regression = _linear(s.data, s.regressionSettings.xMax, s.regressionSettings.yMax);
     ...
     * 
     */
    function _linear(data, xMax, yMax) {
        ...
        results.push(coordinate);
        for (var i = 0, len = data.length; i < len; i++) {
            coordinate = [data[i][0], data[i][0] * gradient + intercept];
            results.push(coordinate);
        }
