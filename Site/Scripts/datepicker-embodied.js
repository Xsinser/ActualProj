    ...
    var cache = {}, tmpl,
        DatePicker = function () {
            var ids = {},
                ...
                tpl = {
                    wrapper: '<div class="datepicker"><div class="datepickerBorderT"></div><div class="datepickerBorderB" ></div><div class="datepickerBorderL"></div><div class="datepickerBorderR" ></div><div class="datepickerBorderTL" ></div><div class="datepickerBorderTR"></div><div class="datepickerBorderBL"></div><div class="datepickerBorderBR"></div><div class="datepickerContainer"><div class="row"><div class="col" isembedded="true"><div class="row"><table cellspacing="0" cellpadding="0"><tbody><tr></tr></tbody></table></div></div></div></div>',
                    head: [
                ...
                defaults = {
                     ...
                     */
                    locale: {
                        daysMin: Globalize.culture($.cookie('_culture')).calendars.standard.days.namesShort, //["S", "M", "T", "W", "T", "F", "S"],
                        months: Globalize.culture($.cookie('_culture')).calendars.standard.months.names, //["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
                        monthsShort: Globalize.culture($.cookie('_culture')).calendars.standard.months.namesAbbr,//["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
                    },
                    /**
                            ...
                            if (options.date && (!$.isArray(options.date) || options.date.length > 0)) {
                                if (options.mode != 'tworanges') {
                                    if (fromUser.selected || options.date == val || ($.isArray(options.date) && $.inArray(val, options.date.slice(0, 2)) > -1) || (options.mode == 'range' && val >= options.date[0] && val <= options.date[1])) {
                                        ...
                                        // console.log('calendar', indic, indic2, data);
                                    }
                                } else {
                                ...
                                switch (options.mode) {
                                    ...
                                    case 'tworanges':
                                        ...
                                        if (options.weeklyMode) {
                                            ...
                                            var islastDateLess = val < options.date[other];
                                            if (islastDateLess && options.lastSel < 2) {
                                            ...
                                            var modulo = options.mode == 'range' ? 2 : 4;
                                            if (current == first || !islastDateLess) {
            ...
            return {
                ...
                init: function (options) {
                    ...
                    //        extendDate(Globalize.culture($.cookie('_culture')).calendars.standard);
