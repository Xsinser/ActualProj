...
/*            if (values_ck) {
               ...
               // $datepicker.DatePickerSetDate(dates);
                ...
                //console.log("Privet", dr1from_ck);
              //  console.log("Privet", dr1from_ck.getFullYear());
                

                var newFrom = Filter.pad(dr1from_ck.getDate()) + '.' + Filter.pad(dr1from_ck.getMonth() + 1) + '.' + dr1from_ck.getFullYear();
                var newTo = Filter.pad(dr1to_ck.getDate()) + '.' + Filter.pad(dr1to_ck.getMonth() + 1) + '.' + dr1to_ck.getFullYear();
                ...
                console.log("dr1from_ck", dr1from_ck);
                console.log("dr1to_ck", dr1to_ck);

                if (newFrom != oldFrom || newTo != oldTo)
                {
                    $('.dr1.from', $dropdown).val(newFrom);
                    $('.dr1.to', $dropdown).val(newTo);
                   // $('.dr1.from', $dropdown).val(dr1from_ck);
                   // $('.dr1.to', $dropdown).val(dr1to_ck);
               ...
               // $('.dr1.from_millis', $dropdown).val(dates[0].getTime());
                ...
                $('.dr1.from_millis', $dropdown).val(dr1from_millis_ck.getTime());
                $('.dr1.to_millis', $dropdown).val(dr1to_millis_ck.getTime());
             ...
             //   }
                ...
                if (event.dr2from) {
                    $('.dr2.from', $dropdown).val(Filter.pad(dr2from_ck.getDate()) + '.' + Filter.pad(dr2from_ck.getMonth() + 1) + '.' + dr2from_ck.getFullYear());
                    $('.dr2.from_millis', $dropdown).val(dr1from_millis_ck.getTime());
                }
             ...
             //   }
                ...
                if (event.dr2to) {
                    $('.dr2.to', $dropdown).val(Filter.pad(dr2to_ck.getDate()) + '.' + Filter.pad(dr2to_ck.getMonth() + 1) + '.' + dr2to_ck.getFullYear());
                    $('.dr2.to_millis', $dropdown).val(dr1to_millis_ck.getTime());
                }
         ...
         // console.log('datesMy', dr1from_ck);
            //console.log('dates[1]', dates[1]);
            //console.log('dates[2]', dates[2]);
            //console.log('dates[3]', dates[3]);
          ...
          */
           // console.log(' ELSE newFrom', newFrom);
           // console.log('ELSE newTo', dates[2]);

            var oldFrom = $('.dr1.from', $dropdown).val();
            var oldTo = $('.dr1.to', $dropdown).val();

          //  console.log(' ELSE oldFrom', oldFrom);
         //   console.log('ELSE oldTo', oldTo);
        ...
        createElements: function ($target) {
            ...
            $target.html(
				'<div class="date-range-field">' +
					...
					//'<div class="arrow"><a href="#"><img src="/Content/images/arrow_white.png"></a></div>' +
				'</div>'             
			);
          ...
          //  console.log("Privet");
            ...
            if (!$dropdown) {
                ...
                $datepicker.DatePicker({
                    ...
                    //	date: [new Date('2020-07-01'), new Date('2013-08-09')],
                ...
                $('#button-ok', $dropdown).click(function () {
                    ...
                    //$.cookie("basket-data", JSON.stringify($current_target.data("DateRangesWidget").options.values), { path: "/" });

                    internal.updateDateField($current_target);
                   // $datepicker.DatePickerSetDate($current_target.data("DateRangesWidget").options.values);
                   // internal.printDateButton($current_target.data("DateRangesWidget").options.values.dr1to, $current_target.data("DateRangesWidget").options.values.dr1from, $current_target.data("DateRangesWidget").options.values);
                   
                   // console.log("getCookie", $current_target.data("DateRangesWidget").options.values.dr1to);
                   // console.log("getCookie", $current_target.data("DateRangesWidget").options.values.dr1from);
                    //console.log('test 2');
                ...
                $('#button-cancel', $dropdown).click(function () {
                    ...
                    //Utilities.deleteCookie('basket-data');
...
/*
            var values_ck1 = $.cookie("basket-data");
            var event1 = JSON.parse(values_ck1);
            dates[0] = new Date(event1.dr1from);
            dates[1] = new Date(event1.dr1to);
*/


            //console.log('new dates', dates[0]);
            //console.log('new dates', dates[1]);
            $datepicker.DatePickerSetDate(dates);
            internal.recalculateComparison();
            /*
...
/*
           ...
           // if (end == -1) {end = value.length;}//value.indexOf('}', start);
...
*/
  ...
  */          
        ...
        updateDateField: function ($target) {
            ...
            var event = JSON.parse(values_ck);
/*
            console.log('event0', event.dr1from);
            var dd = new Date(event.dr1from);
            console.log('event0', dd);

            var event2 = JSON.parse(values_ck, function (key, value) {
                if (key == 'dr1to') return new Date(value);
                return value;
            });
            ...
            if (values_ck) {
             ...
             if (values_ck) {
                ...
                if (comparisonEnabled_ck ) {
                   ...
                   // console.log(' else values.comparisonEnabled && values.dr2from && values.dr2to');
                }
               // console.log('IF');
                ...
                if (values.dr1from && values.dr1to) {
                    ...
                    //var tmp = "custom";
                    //console.log('values.daterangePreset', values.daterangePreset);
...
/*
        ...
        deleteCookie : function (name) {
                       internal.setCookie(name, "", {expires: -1})
        },
 ...
 */     
        ...
        getDaterangePreset: function () {
            ...
            //console.log("daterangePreset!!!!", db.date_presets[value]);
           //return db.date_presets["today"];
        ...
        checkDateRange: function (dates) {
            ...
            if (dates[0] > dates[1]) {
                dates[0] = dates[1];
                //$datepicker.DatePickerSetLastSel('1');
                update = true;
            }
